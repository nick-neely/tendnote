...
describe("Phase 2E Contacts import boundary - no external write or inference side effects", () => {
  it("scans every current Contacts import source surface", () => {
    expect(CONTACT_IMPORT_SURFACES).toEqual([
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/contact-import-preview-client.tsx",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/contact-import-preview-fixture.tsx",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/contact-import-review.tsx",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/page.tsx",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/refresh-preview-button.tsx",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/resolution-zone.tsx",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/review-columns.tsx",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/review-controls.tsx",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/review-model.ts",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/review-table-features.ts",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/review-table.tsx",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/review-toasts.ts",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/use-confirm-runner.ts",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/use-contact-import-review.ts",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/use-reduced-motion.ts",
      "apps/web/src/app/(member)/(admitted)/account/contacts/import/use-review-working-set.ts",
