 ...
 * 2. `data-active={isActive}` is `data-active={isActive || undefined}` on the
 *    two menu buttons. React renders a `false` data attribute as the *string*
 *    `"false"`, and Tailwind v4 compiles `data-active:` to `[data-active]` —
