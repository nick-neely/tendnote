...
- **Release:** `skill-v4.2.0`
- **Pinned upstream files:** the release's
  [`plugin/skills/impeccable/SKILL.md`](https://raw.githubusercontent.com/pbakaus/impeccable/skill-v4.2.0/plugin/skills/impeccable/SKILL.md)
  identifies version `4.2.0` and Apache-2.0; the release
  [`LICENSE`](https://raw.githubusercontent.com/pbakaus/impeccable/skill-v4.2.0/LICENSE)
  is reproduced at [`LICENSES/Apache-2.0.txt`](LICENSES/Apache-2.0.txt).
- **Upstream NOTICE:** The pinned release contains
  [`NOTICE.md`](https://raw.githubusercontent.com/pbakaus/impeccable/skill-v4.2.0/NOTICE.md).
...
- **NOTICE review:** The pinned `skill-v4.2.0` release's `NOTICE.md` was
  retrieved and checked on 2026-09-04. The notice identifies content derived
  ...
  cited upstream repository on 2026-09-04.
...
The v4.2.0 updater installs launchers and generated harness hooks and agent
definitions. The v0.1.0 native engine downloaded into each variant's `scripts/bin/`
is a local, ignored runtime cache; binaries are not redistributed here. The
version-pinned launchers obtain the engine for the current host. The skill
instructions and references remain source-form files. If either variant is
