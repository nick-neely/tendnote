CREATE TYPE "public"."general_action_offer_kind" AS ENUM('holder_reminder', 'responsibility_handoff');--> statement-breakpoint
...
CREATE TABLE "general_action_offer_declines" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"general_action_id" uuid NOT NULL,
	"user_id" text NOT NULL,
	"offer_kind" "general_action_offer_kind" NOT NULL,
...
ALTER TABLE "general_action_offer_declines" ADD CONSTRAINT "general_action_offer_declines_general_action_id_general_actions_id_fk" FOREIGN KEY ("general_action_id") REFERENCES "public"."general_actions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "general_action_offer_declines" ADD CONSTRAINT "general_action_offer_declines_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "general_action_offer_declines_action_user_kind_idx" ON "general_action_offer_declines" USING btree ("general_action_id","user_id","offer_kind");--> statement-breakpoint
